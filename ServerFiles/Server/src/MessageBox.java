 ...
 * sotto-thread di {@link ServerThread}({@link TheWaiter}) staranno sempre in
 * attesa di una
 * possibile modifica della mappa {@link MessageBox#messageMap messageMap} e, in
 * tal caso,
 * leggeranno il messaggio. La mappa memorizza i messaggi {@link Message} per
 * gli utenti connessi
 * al sistema. La mappa è indicizzata con lo username del destinatario del
 * messaggio.
 * <p>
 * Allo stesso modo ogni volta che un client vuole inviare un messaggio sara' il
 * {@link ServerThread}
 * a salvare il messaggio tramite il metodo {@link MessageBox#writeMessage
 * writeMessage()}.
 * 
...
public class MessageBox {
    /**
     * Segna il numero di {@link TheWaiter} in lettura. Se >0 non è possibile
     * scrivere in {@link MessageBox#messageMap messageMap}.
     */
    ...
    /**
     * Flag che diventa {@code TRUE} o {@code FALSE} a seconda della disponibilita'
     * della {@link MessageBox#messageMap mappa}
     */
    ...
    /**
     * Metodo sincronizzato che, ogni volta che un utente si registra/esegue il
     * login nella mappa viene
    ...
    /**
     * Metodo sincronizzato che consente la scrittura da parte di
    ...
    /**
     * Metodo che consente la lettura dei messaggi da parte del sottoThread
     * {@link TheWaiter} di un singolo utente.
     * Il metodo consente la lettura simultanea da parte di piu' thread ma, se i
     * thread leggono gli altri non possono scrivere.
     * In caso in cui l'utente non abbia messaggi {@link TheWaiter il thread} andra'
     * in attesa.
     * 
     * @param receiver
